<template>
  <div class="etlap">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          <div v-for="favProduct in favProducts" v-bind:key="favProducts.prId" class="col">
            <div class="card shadow-sm">
              ...
              <div class="card-body">
                <div class="card-text">
                  <p class="mb-3 h5">{{ favProduct.prName }}</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div class=" position-relative ff_comfortaa bg_light_green text_dark_green lg_shadow">
      <a href="/pizza-hozzaadasa" id="pizzaAdminBtn" v-if="jog == 9" class="position-absolute btn btn-sm btn-primary mt-5"><svg
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div v-if="jog == 9" class="btn-group">
                        <a href="/pizza-modositasa" class="btn btn-sm btn-outline-secondary" @click="modifyClick(product.prId)"><svg
